...
/**
 * Custom toast class. Can be used if we want to have a customized toast
 * througtout the application.
 *
 * @author Salim Shaikh
 */
public class CustomToast {
    ...
    public static void show(final Activity activity, final int messageResId,
        ...
        try {
                    ...
                    public void run() {
                        try {
                            ...
                            Log.e(MainApplication.LOG_TAG,
                                    "CustomToast: show: run: Exception->"
                                            + e.getMessage());
                            e.printStackTrace();
                        }
                    }
            ...
            Log.e(MainApplication.LOG_TAG,
                    "CustomToast: show: Exception->" + e.getMessage());
            e.printStackTrace();
        }
    }
